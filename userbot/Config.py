...
if ENV:
    ...
    class Config(object):
        ...
        APP_ID = os.environ.get("APP_ID", "21568806")
        ...
        ASSISTANT = os.environ.get("ASSISTANT", "6049338121")
        ABUSE = os.environ.get("ABUSE", None)
        BOTLOG_CHATID = os.environ.get("LOGGER_ID", "-1001808960170")
        ...
        PRIVATE_GROUP_ID = os.environ.get("LOGGER_ID", "-1001808960170")
